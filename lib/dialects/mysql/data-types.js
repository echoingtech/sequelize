...
module.exports = BaseTypes => {
  ...
  BaseTypes.SET.types.mysql = false;
  ...
  class ENUM extends BaseTypes.ENUM {
    ...
    _stringify(values, options) {
      return `(${values.map(value => options.escape(value)).join(', ')})`;
    }
  }

  class SET extends BaseTypes.SET {
    toSql(options) {
      return `SET(${this.values.map(value => options.escape(value)).join(', ')})`;
    }
  }
