    ...
    if (this.isDescribeQuery()) {
      ...
      for (const _result of data) {
        ...
        result[_result.Field] = {
          type: enumRegex.test(_result.Type) ? _result.Type.replace(enumRegex, 'ENUM') : setRegex.test(_result.Type) ? _result.TYpe.replace(setRegex, 'SET') : _result.Type.toUpperCase(),
